import{d as n}from"../../../assets/projects-78434c5c.js";document.addEventListener("DOMContentLoaded",()=>{console.log(n);const a=document.querySelector(".js-gallery"),s=document.getElementById("optionSelect");function l(t){if(a.innerHTML="",!t||t.length===0){a.innerHTML="<p>No hay proyectos para mostrar.</p>";return}[...t].sort((e,r)=>r.id-e.id).forEach(e=>{const r=e.imageDescriptions&&e.imageDescriptions[0]?e.imageDescriptions[0]:"Descripción no disponible",o=e.images&&e.images[0]?e.images[0]:"";let i="";o.includes("youtube.com")||o.includes("vimeo.com")?i=`
